...
const char *ssid = "kotkot"; // Enter your WiFi name
const char *password = "stellaartois4students";  // Enter WiFi password

// Define MQTT broker information
const char *mqtt_server = "192.168.86.133";
...
void callback(char *topic, byte *payload, unsigned int length) {
  ...
  if (strcmp(topic, mqttRestartArduinoTopic) == 0) {
    if (strncmp((char *)payload, mqttRestartArduinoMessage, length) == 0) {
