...
const char *mqttPuzzleCompleteTopic = "prop3/puzzleCompleteCamera3";
const char *mqttPuzzleCompleteMessage = "completed";

const char *mqttRestartArduinoTopic = "prop3/restartArduinoCamera3";
const char *mqttRestartArduinoMessage = "restarted";

const char *mqttStartChallengeTopic = "prop3/startChallenge3Camera3";
...
void reconnectMQTT() {
  client.setServer(mqtt_server, mqtt_port);
   ...
   while (!client.connected()) {
    ...
    if (client.connect("CameraClient3")) {
